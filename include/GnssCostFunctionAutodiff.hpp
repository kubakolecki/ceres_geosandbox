...
class GnssCostFunctionAutodiff
{
    public:
    
    GnssCostFunctionAutodiff(const ceres_geosandbox::Point2dEastingNorthing& observedCoordinates, double uncertainty): m_observedCoordinates{observedCoordinates}, m_uncertainty{uncertainty}
    {}
