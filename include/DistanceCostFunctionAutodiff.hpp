...
class DistanceCostFunctionAutodiff
{
    public:
        explicit DistanceCostFunctionAutodiff(double distance, double distanceUncertainy): m_distance(distance), m_distanceUncertainty(distanceUncertainy)
        { }
